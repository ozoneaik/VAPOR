                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 justify-content-end d-flex ">
                                    @if ($leave_form->status == 'อนุมัติ')
                                        <a href="{{ route('pdf', $leave_form->id) }}" class="btn btn-info mr-3" target="_blank">พิมพ์ใบลา</a>
                                    @endif
                                    <a href="{{ route('cancel', $leave_form->id) }}" class="btn btn-danger mr-2" onclick="event.preventDefault(); cancelLeaveForm({{ $leave_form->id }});">ยกเลิกใบลา</a>
