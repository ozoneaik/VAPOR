                                    ...
                                    <table id="req_list_table" class="table table-bordered table-hover text-center">
                                        ...
                                        @foreach ($leave_forms_rep as $leave_form)
                                            <tr>
                                                ...
                                                <td style="{{ $style }} max-width: 40px;">{{ $leave_form->name }}</td>
                                                ...
                                                <td style="{{ $style }} max-width: 20px;">
                                                    @if(Auth::user()->type == 'hr(admin)')
                                                        <a href="{{ route('hr.req.emp.detail', $leave_form->id) }}"><i class="fas fa-file-invoice"></i></a>
                                                    @elseif(Auth::user()->type == 'pm')
                                                        <a href="{{ route('pm.req.emp.detail', $leave_form->id) }}"><i class="fas fa-file-invoice"></i></a>
                                                    @elseif(Auth::user()->type == 'ceo')
                                                        <a href="{{ route('ceo.req.emp.detail', $leave_form->id) }}"><i class="fas fa-file-invoice"></i></a>
                                                    @endif
